/*
    Cookie Consent Notice Type H3 by Jurgen Geitner
...
class CookieConsentNotice {
  ...
  checkStatus() {
    switch (localStorage.getItem("CookieConsentNoticeH3")) {
      case "1":
  ...
  acceptCookies() {
    localStorage.setItem("CookieConsentNoticeH3", "1")
    this.openManageCookies()
    this.activateTracking()
    this.addCustomScript()
  }
  ...
  rejectCookies() {
    localStorage.setItem("CookieConsentNoticeH3", "0");
    this.openManageCookies();
