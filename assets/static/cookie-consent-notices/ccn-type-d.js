...
class CookieConsentNotice {
  ...
  addCss() {
    ...
    stylesheet.setAttribute('href', '/static/cookie-consent-notices/ccn-type-d.css');
  ...
  checkStatus() {
    switch (localStorage.getItem("CookieConsentNoticeD")) {
      case "1":
  ...
  acceptCookies() {
    localStorage.setItem("CookieConsentNoticeD", "1")
    this.openManageCookies()
    this.activateTracking()
    this.addCustomScript()
  }
  ...
  rejectCookies() {
    localStorage.setItem("CookieConsentNoticeD", "0");
    this.openManageCookies();
