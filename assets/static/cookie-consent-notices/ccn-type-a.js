...
class CookieConsentNotice {
  ...
  addCss() {
    ...
    stylesheet.setAttribute('href', '/static/cookie-consent-notices/ccn-type-a.css');
  ...
  checkStatus() {
    switch (localStorage.getItem("CookieConsentNoticeA")) {
      case "1":
  ...
  acceptCookies() {
    localStorage.setItem("CookieConsentNoticeA", "1")
    this.openManageCookies()
    this.activateTracking()
    this.addCustomScript()
  }
  ...
  rejectCookies() {
    localStorage.setItem("CookieConsentNoticeA", "0");
    this.openManageCookies();
