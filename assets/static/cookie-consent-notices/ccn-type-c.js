...
class CookieConsentNotice {
  ...
  addCss() {
    ...
    stylesheet.setAttribute('href', '/static/cookie-consent-notices/ccn-type-c.css');
  ...
  checkStatus() {
    switch (localStorage.getItem("CookieConsentNoticeC")) {
      case "1":
  ...
  acceptCookies() {
    localStorage.setItem("CookieConsentNoticeC", "1")
    this.openManageCookies()
    this.activateTracking()
    this.addCustomScript()
  }
  ...
  rejectCookies() {
    localStorage.setItem("CookieConsentNoticeC", "0");
    this.openManageCookies();
