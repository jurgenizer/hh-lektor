...
class CookieConsentNotice {
  ...
  addCss() {
    ...
    stylesheet.setAttribute('href', '/static/cookie-consent-notices/ccn-type-e.css');
  ...
  checkStatus() {
    switch (localStorage.getItem("CookieConsentNoticeE")) {
      case "1":
  ...
  acceptCookies() {
    localStorage.setItem("CookieConsentNoticeE", "1")
    this.openManageCookies()
    this.activateTracking()
    this.addCustomScript()
  }
