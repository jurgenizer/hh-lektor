/*
    Cookie Consent Notice Type H2 by Jurgen Geitner
...
class CookieConsentNotice {
  ...
  checkStatus() {
    switch (localStorage.getItem("CookieConsentNoticeH2")) {
      case "1":
  ...
  acceptCookies() {
    localStorage.setItem("CookieConsentNoticeH2", "1")
    this.openManageCookies()
    this.activateTracking()
    this.addCustomScript()
  }
  ...
  rejectCookies() {
    localStorage.setItem("CookieConsentNoticeH2", "0");
    this.openManageCookies();
